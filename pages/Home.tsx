...
import { Calendar, User, Tag, ArrowDownAZ, ArrowUpAZ, Search, X, ChevronLeft, ChevronRight } from 'lucide-react';
                ...
                >
                  ...
                  <div className="flex gap-2 mb-2 flex-wrap">
                    ...
                    {post.tags.slice(0, 2).map(tag => (
                      <span key={tag} className="bg-white text-gray-900 px-2 py-0.5 rounded text-xs font-bold border-2 border-black flex items-center gap-1">
                        <Tag size={10} /> {tag}
                      </span>
                    ))}
                  </div>

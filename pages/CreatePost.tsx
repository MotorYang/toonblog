...
import { Wand2, Save, Lock, Image as ImageIcon, Upload, X, Eye, Edit3 } from 'lucide-react';
...
export const CreatePost: React.FC = () => {
  ...
  const handleAIWrite = async () => {
    ...
    try {
      const generatedContent = await generateBlogContent(title, "Make it funny and cartoonish. Use Markdown formatting like **bold**, ## Headings, and bullet points.");

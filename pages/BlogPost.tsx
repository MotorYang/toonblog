...
import { ArrowLeft, Sparkles, Trash2, Calendar, User, Eye } from 'lucide-react';
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      <ToonCard className="relative overflow-hidden">
        ...
        {/* Title & Meta */}
        <h1 className="text-3xl md:text-5xl font-black mb-4 leading-tight break-words">{post.title}</h1>
        ...
        <div className="mb-8 p-4 bg-toon-bg border-2 border-dashed border-black rounded-xl">
          ...
          {summary && (
            <p className="font-medium text-gray-800 italic animate-pulse">
              "{summary}"
            </p>
          )}
        </div>
